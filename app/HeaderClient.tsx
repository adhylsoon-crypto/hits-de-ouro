  ...
  return (
    <>
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 50, background: 'rgba(10,10,10,0.95)', backdropFilter: 'blur(10px)', borderBottom: '1px solid rgba(184,134,11,0.3)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '12px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <nav className="desktop-nav" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', borderLeft: '1px solid #333', paddingLeft: '16px' }}>
              ...
              <a href="https://www.youtube.com/@HITSDEOURO" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '32px', height: '32px', borderRadius: '8px', background: '#cc0000', border: '1px solid #cc0000' }}>
              ...
              <a href="https://www.instagram.com/hits_de_ouro/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '32px', height: '32px', borderRadius: '8px', background: 'linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)', border: 'none' }}>
              ...
              <a href="https://br.pinterest.com/HITSDEOURO/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '32px', height: '32px', borderRadius: '8px', background: '#e60023', border: '1px solid #e60023' }}>
            ...
            {user ? (
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <a href="/favoritas" style={{ padding: '8px 16px', borderRadius: '10px', background: '#1a1a1a', border: '1px solid #333', color: '#FFD700', fontWeight: 'bold', fontSize: '0.85rem', textDecoration: 'none' }}>⭐ Favoritas</a>
                <button onClick={handleLogout} style={{ padding: '8px 16px', borderRadius: '10px', background: 'transparent', border: '1px solid #333', color: '#aaa', fontWeight: 'bold', fontSize: '0.85rem', cursor: 'pointer' }}>Sair</button>
              </div>
            ) : (
          ...
          <div className="mobile-right" style={{ display: 'none', alignItems: 'center', gap: '8px' }}>
            {user ? (
              <a href="/favoritas" style={{ padding: '7px 12px', borderRadius: '8px', background: '#1a1a1a', border: '1px solid #333', color: '#FFD700', fontWeight: 'bold', fontSize: '0.8rem', textDecoration: 'none' }}>⭐</a>
            ) : (
        ...
        <div className="mobile-social" style={{ display: 'none', justifyContent: 'center', gap: '10px', padding: '8px 20px', borderTop: '1px solid #1a1a1a', background: 'rgba(10,10,10,0.95)' }}>
        ...
        {menuOpen && (
          <div className="mobile-menu" style={{ display: 'none', flexDirection: 'column', padding: '12px 20px 16px', borderTop: '1px solid #222', gap: '4px' }}>
            <a href="/" onClick={() => setMenuOpen(false)} style={{ color: '#aaa', textDecoration: 'none', fontSize: '1rem', padding: '10px 0', borderBottom: '1px solid #1a1a1a' }}>Inicio</a>
            <a href="/contato" onClick={() => setMenuOpen(false)} style={{ color: '#aaa', textDecoration: 'none', fontSize: '1rem', padding: '10px 0', borderBottom: '1px solid #1a1a1a' }}>Contato</a>
            {user && (
              <button onClick={handleLogout} style={{ padding: '10px 0', background: 'transparent', border: 'none', color: '#aaa', fontWeight: 'bold', fontSize: '1rem', cursor: 'pointer', textAlign: 'left' }}>Sair</button>
            )}
          </div>
        )}
